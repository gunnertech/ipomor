...
router.post('/password_reset', function(req, res) {
  User.findOne({ 'email': req.body.email }, function(err, user) {
    ...
    if (user) {
      ...
      email.html = '<p>Did you forget your password?</p> <p><a href="https://' + req.headers.host + '/users/' + user.id + '/password_reset/' + user.resetPasswordToken +  '">Click this link to reset your password</a> or copy and paste this link in your browser https://' + req.headers.host + '/users/' + user.id + '/password_reset/' + user.resetPasswordToken +  '</p><p>Please note this link will expire in 1 hour.</p> <p>If you did not request this email please disregard it.</p>'
    } else {
